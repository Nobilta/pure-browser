...
最新功能与验证记录以 [README](./README.md) 为入口，源码位于 `app/src/main` 和 `rust/`。
...
| 媒体/投屏 | 基础流程已完成 | 菜单/增强全屏入口、DLNA 设备选择；YouTube/自定义播放器保留网页控件 |
...
- 当前为 DLNA 直投，尚无 Google Cast 或远端会话控制界面；YouTube 通常没有当前嗅探器支持的完整媒体地址。
