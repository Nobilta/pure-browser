...
更新：2026-09-13，适用于 0.7.3。本次增强播放器验证见 [专项记录](enhanced-player-validation.md)，其他模拟器和网站结果见 [回归报告](../EMULATOR_TEST_REPORT.md)。
...
网页内接管脚本、控制层、样式、定位观察器和对应设置广播已删除；非全屏只观察播放状态，不修改控件。
